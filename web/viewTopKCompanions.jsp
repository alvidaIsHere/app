...
<html>
    ...
    <body>
        ...
        <div class='container-fluid' style='align: center;'>
            ...
            <h4 align='center'>{ View Top k Companions }</h4>  
            <br />
            <div class="well">
                <div class='row' align="center">
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="student_name" name="student_name" class="chosen-select" data-placeholder="MAC Address">
                                <%
                                    //display all names
                        ...
                        <div class="col-md-4">
                            ...
                            <div id="from_datetime" class="input-group">
                                <input type="text" style='height: 25px' required name="from_datetime" id="from_datetime_val" class="form-control" data-format="yyyy-mm-dd HH:MM:ss"  placeholder="Date"/>
...
<script type="text/javascript">
    ...
    function generateReport() {
        ...
        xmlhttp.open("GET", "ViewTopCompanionServlet.do?startTime=" + from_date + "&KValue=" + kVal + "&MAC=" + student, true);
        xmlhttp.send();
    }
    ;
</script>