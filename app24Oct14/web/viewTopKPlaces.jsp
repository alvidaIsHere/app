    ...
    <body>
        ...
        <div class='container-fluid' style='align: center;'>
            <div class='row' align="center">                
                <h2 align="center">View Top k Places</h2>
                <div class="form-group">
                    <div class="well">
                        <form method="POST" action="basicViewTopKPlaces.do">
                            <div class="col-md-6">
...
<script type="text/javascript">
    ...
    function generateReport() {
        ...
        xmlhttp.open("GET", "basicViewTopKPlaces.do?datetime=" + datetime + "&KValue=" + KValue, true);
        xmlhttp.send();
    }
    ;
</script>
