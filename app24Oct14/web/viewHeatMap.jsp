        ...
        <div class='container-fluid' style='align: center;'>
            <div class='row'>
                <div class='col-md-12' align='center'>
                    <h2 align="center">View Heat Map</h2>                       
                    <div class="well">                         
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <div id="datetimepicker" class="input-group">
                                        <input style="height: 25px" name="datetime" id="datetime" class="form-control" required data-format="yyyy-mm-dd HH:MM:ss" type="datetime" />
