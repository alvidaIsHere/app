...
public class UsersInLocation {
    ...
    /**
     * This constructor creates a UsersInLocation object that takes in a user
     * mac-address and the list of locations that s/he has been to
     *
     * @param mac_address the mac address of this user
     * @param locations the list of locations that this user has been to
     */
    ...
    /**
     *
     * @return the printed list of locations and time that this user has been to
     */
