<%-- 
    Document   : viewTopKNextPopularPlaces
    Created on : Oct 5, 2014, 8:58:58 AM
...
<html>
    ...
    <head>
        ...
        <title>View Top K Next Popular Places</title>
    ...
    <body>
        ...
        <div class='container-fluid' style='align: center;'>
            ...
            <h4 align='center'>{ View Top k Next Popular Places }</h4> 
            <div class='well'>
                    ...
                    <div class='form-group'>
                        <form method='POST' action='ViewTopkNextPlaces.do' name="nextPlaceForm" onsubmit="validateForm()">
                            ...
                            <div class='col-md-4'>
                                ...
                                <select class='chosen-select1' name="semanticPlace" id='location' data-placeholder="Select Location">
                            ...
                            <div class='col-md-4'>
                                ...
                                <div id="datetimepicker" class="input-group">
                                    <input type="text" style='height: 30px' required name="atTime" id="period" class="form-control" data-format="yyyy-mm-dd HH:MM:ss"  placeholder="Date/Time"/>
...
<script type="text/javascript">
    $(function() {
        $('#datetimepicker').datetimepicker({
            ...
            defaultDate: '2014-04-01 15:30:00'
        });
    ...
    function generateReport() {
        ...
        xmlhttp.open("POST", "ViewTopkNextPlaces.do?kValue=" + kVal + "&atTime=" + period + "&semanticPlace=" + location, true);
        xmlhttp.send();
        //http://localhost:8080/sloca_app/ViewTopkNextPlaces.do?kValue=3&atTime=2014-03-23%2000:40:00&semanticPlace=SMUSISL1LOBBY
        //http://localhost:8080/sloca_app/ToggleTopKNextPlaces.do?kValue=3&atTime=2014-03-24%2015:30:00&semanticPlace=SMUSISL1LOBBY
    }//jsonlint.com
    ;
</script>